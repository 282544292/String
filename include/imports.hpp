...
extern "C" __declspec(dllimport) void Concat(uint8_t * ret, uint8_t *str1, int32_t len1, uint8_t *str2, int32_t len2);
...
extern "C" __declspec(dllimport) int8_t TryEncodingConvert(uint8_t *ret, int64_t *retLen, uint8_t *str, int32_t len, int32_t encoding1, int32_t encoding2);